...
export default function DropdownInvoiceType({ value, setValue, darkMode = false }) {
    ...
    return (
        <>
            ...
            <Text style={{ fontSize: getFontSize(17), marginBottom: 10, display: "flex", fontWeight: "400", backgroundColor: darkMode ? "#243241" : Colors.PRIMARY, color: "white", paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 }}>APLICAR A</Text>
